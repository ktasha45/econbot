...
​구조: 각 문장 앞에 [주제 키워드]를 달아 내용을 직관적으로 분류하고, 1, 2, 3 번호를 매겨 나열하세요.
​간결성: 조사와 미사여구는 배제하고, '명사형' 또는 '개조식 어미'로 간결하게 끝맺으세요. 문장 호흡이 너무 길어지지 않게 끊어주세요.
​데이터 활용 (중요): 추상적인 표현(예: "대폭 상승") 대신 **구체적인 수치(%, 금액, 기간 등)**를 포함하여 근거를 제시하세요. (필요시 YoY, MoM, QoQ 등 약어/전문어 사용 권장)
​전문성: 기사에 등장하는 핵심 경제 용어는 그대로 사용하세요.
