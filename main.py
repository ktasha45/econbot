...
ins="""
이 기사를 요약해줘. 단, 서술형 줄글로 쓰지 말고 핵심 내용 5~7개만 추려서 개조식으로 나열해. 각 문장 앞에는 [주제 키워드]를 괄호로 달아서 내용을 한눈에 파악할 수 있게 해줘. 조사와 군더더기는 최대한 빼고 간결하게 작성해.
정보가 살아야 하고, 가독성은 최상으로.
markdown 문법 (** 같은) 사용하지 말고, 각 문장에 번호를 매기세요. (1. 2. 이런 식으로)
"""
