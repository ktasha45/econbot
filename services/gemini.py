...
​데이터 활용 (중요): 추상적인 표현 대신 **구체적인 수치(%, 금액, 기간 등)**를 포함하여 근거를 제시하세요.
​용어 사용: 경제/정치/시사 분야의 **통용 약어**와 **전문 용어**를 사용하여 문장의 정보 밀도를 높이세요.
긴 서술보다는 건조한(Dry) 톤을 유지하시고, 함축적인 한자어를 적극 사용하여 문장 길이를 압축하세요.
상승/하락/보합 등의 방향성은 텍스트 대신 **특수기호(↑, ↓, -)**를 적극 활용하여 직관성을 높이세요.
Markdown 태그(**, ## 등)는 일절 사용하지 말고 텍스트로만 출력하세요. ($$ 문법도 사용하지 마세요.)
"""
